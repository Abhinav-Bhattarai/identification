          ...
          <section className="p-6">
            ...
            <form className="space-y-8 lg:space-y-12 pt-6 lg:pt-8">
              ...
              <div className="space-y-4">
                ...
                <InfoText>Select which type of event this policy should be applied to.</InfoText>
                <Select>
              ...
              <div className="space-y-4">
                ...
                <InfoText>
                  By default, when a policy matches, the configured inline action is returned in the
                  Risk and Filter API Response, and further policy evaluation is halted. By enabling
                  pass-through mode, the policy will not return any inline action when matched. Only
                  the configured actions will be executed and evaluation will continue to the next
                  policy.
                </InfoText>
